...
Mat hsv,result,thresh,edge,threshold1;
...
threshold(result,threshold1,LowH,LowS,THRESH_BINARY);
...
//inRange(hsv,Scalar(56,86,69),Scalar(HighH ,HighS,HighV),thresh);
